<template>
    <div v-show="loading" class="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <div class="bg-white bg-transparent  p-8 rounded-lg flex items-center">
            <div class="mr-4 animate-spin rounded-full h-12 w-12 border-t-4 border-green-500 border-solid"></div>
            <div class="text-gray-800">Onboarding is in process...</div>
        </div>
    </div>
    
    <div  v-show="!loading" class="p-4 w-full main_content" 
    style="height: 100vh;">
             ...
             bg-gray-50 dark:bg-gray-800">
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="server_ip" v-model="server_ip" @input="validateServerIpFormat" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="0.0.0.0" required />
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" id="user" v-model="server_username" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Username" required>
  ...
  -----END RSA PRIVATE KEY-----"
      ...
      <div v-if="errors.private_key" class="text-red-500 text-sm mt-1">
        {{ errors.private_key }}
                ...
                <!-- <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="server_password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            Password</label>
                        <input type="password" v-model="server_password" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="*********" required>
                ...
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="os" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                            OS Type</label>
                        <select id="os" v-model="server_type" @change="onOsTypeChange" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    export default {
        ...
        methods: {
            onBoard() {
                ...
                // Check if server IP format is valid
                // if (!this.isValidServerIpFormat(this.server_ip)) {
                //     this.errors.server_ip = 'Invalid server IP format.';
                //     setTimeout(() => {
                //         this.errors.server_ip = '';
                //     }, 5000);
                // }
                ...
                if (Object.keys(this.errors).length > 0) {
                    // If there are errors, don't proceed with the request
                    return;
                }
                ...
                axios.post("http://127.0.0.1:8000/api/v3/onboard/", fromData)
                    .then(response => {
                        this.loading = false;
                        this.server_ip = '';
                        this.server_username = '';
                        this.server_password = '';
                        this.private_key,  // Add private_key to the request data
    ...
    <style scoped>
    .main_content {
        background: linear-gradient(90deg, #eeecee 0%, #8167c9 100%);
     }
